...
export default function SystemMetrics() {
  ...
  if (!metrics) {
    return (
      <Card>
        <div className="p-6 text-center text-muted-foreground">Loading system metrics...</div>
      </Card>
    );
  }
        ...
        <div className="space-y-4">
          ...
          <div>
            <div className="flex justify-between mb-1">
              ...
              <span className="text-sm text-muted-foreground">{metrics.disk.toFixed(1)}%</span>
            </div>

...
function getRating(value: number, thresholds: { good: number; poor: number }): PerformanceRating['rating'] {
...
export default function PerformanceDashboard() {
  ...
  const lcpRating = metrics.lcp !== null ? getRating(metrics.lcp, { good: 2500, poor: 4000 }) : null;
  const fcpRating = metrics.fcp !== null ? getRating(metrics.fcp, { good: 1800, poor: 3000 }) : null;
  const clsRating = metrics.cls !== null ? getRating(metrics.cls, { good: 0.1, poor: 0.25 }) : null;
  const ttfbRating = metrics.ttfb !== null ? getRating(metrics.ttfb, { good: 800, poor: 1800 }) : null;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-foreground bg-background border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-muted"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              {lcpRating && (
                <Badge variant={getRatingColor(lcpRating)}>{lcpRating}</Badge>
              )}
            </div>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              {inpRating && (
                <Badge variant={getRatingColor(inpRating)}>{inpRating}</Badge>
              )}
            </div>
            <p className="text-2xl font-bold text-foreground">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              {clsRating && (
                <Badge variant={getRatingColor(clsRating)}>{clsRating}</Badge>
              )}
            </div>
            <p className="text-2xl font-bold text-foreground">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              {fcpRating && (
                <Badge variant={getRatingColor(fcpRating)}>{fcpRating}</Badge>
              )}
            </div>
            <p className="text-2xl font-bold text-foreground">
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              {ttfbRating && (
                <Badge variant={getRatingColor(ttfbRating)}>{ttfbRating}</Badge>
              )}
            </div>
            <p className="text-2xl font-bold text-foreground">

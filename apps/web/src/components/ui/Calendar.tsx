      ...
      days.push(
        <div
          ...
          className={clsx(
            ...
            isCurrentDay &&
              'bg-primary-50 dark:bg-primary-900/40 border-primary-500 dark:border-primary-400'
          )}
        ...
        >
          ...
          <div className="space-y-1">
            ...
            {dayEvents.length > 3 && (
              <div className="text-xs text-muted-foreground">+{dayEvents.length - 3} autres</div>
            )}
          </div>
        </div>
      );

...
// Main Tabs Component
export default function Tabs({ children, tabs, defaultTab, onChange, className, variant = 'default' }: TabsProps) {
      ...
      underline: {
        ...
        tab: (isActive: boolean) =>
          clsx(
            ...
            isActive ? 'text-primary-600 dark:text-primary-400' : 'text-muted-foreground hover:text-foreground',

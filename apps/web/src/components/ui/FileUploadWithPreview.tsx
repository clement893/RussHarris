      ...
      {files.length > 0 && (
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {files.map((file, index) => (
            <div
              key={index}
              className="relative group border border-border rounded-lg overflow-hidden bg-gray-50 dark:bg-gray-800"
            >
              {previews[file.name] ? (
                ...
                <div className="aspect-square flex flex-col items-center justify-center p-4">
                  ...
                  <p className="text-xs text-foreground text-center truncate w-full px-2">
                    {file.name}
                  </p>

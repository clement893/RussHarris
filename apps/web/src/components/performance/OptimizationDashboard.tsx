      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">Real-time performance metrics and monitoring</p>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-muted rounded-lg">
                ...
                <div className="text-lg font-semibold text-foreground">{metrics.network.downlink} Mbps</div>
              </div>
              <div className="p-4 bg-muted rounded-lg">
                <div className="text-sm text-muted-foreground mb-1">RTT</div>
                <div className="text-lg font-semibold text-foreground">{metrics.network.rtt} ms</div>
              </div>
            </div>
          </div>
        )}

...
export default function AboutRussPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white text-gray-900">
      ...
      <section className="relative min-h-[40vh] flex items-center overflow-hidden pt-20 pb-10 md:pt-16 md:pb-10 bg-gradient-to-br from-[#1F2937] via-[#111827] to-[#0F172A]" data-header-contrast="dark">

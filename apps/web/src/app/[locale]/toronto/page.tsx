  ...
  const pricingOptions = [
    {
      ...
      badge: 'Meilleur prix',
      deadline: 'Jusqu\'au 1er mai 2026',
      features: [
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-12">
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 rounded-2xl p-6 border border-gray-700/50">
              ...
              <div className="text-white">
                ...
                <div className="text-xl font-bold">14-15 juin 2026</div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 rounded-2xl p-6 border border-gray-700/50">
              ...
              <div className="text-white">
                ...
                <div className="text-lg font-bold">Metro Toronto Convention Centre</div>
              </div>
            </div>
            <div className="bg-gradient-to-r from-gray-900/50 to-gray-800/30 rounded-2xl p-6 border border-gray-700/50">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600">
                  <strong>Metro Toronto Convention Centre</strong>
                  <br />

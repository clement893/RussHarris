...
fbq('track', 'PageView');
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=791431420680241&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {/* End Meta Pixel Code */}
      ...
      >
        ...
        {/* LinkedIn Insight Tag - global footer, just above closing body */}
        <script
          type="text/javascript"
          dangerouslySetInnerHTML={{
            __html: `
_linkedin_partner_id = "8794810";
...
s.parentNode.insertBefore(b, s);})(window.lintrk);
        ...
        <noscript>
          <img
            ...
            style={{ display: 'none' }}
            alt=""
            src="https://px.ads.linkedin.com/collect/?pid=8794810&fmt=gif"
          />
        </noscript>
      </body>
    </html>

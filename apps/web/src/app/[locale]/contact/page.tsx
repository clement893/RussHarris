...
export default function ContactPage() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-white text-gray-900">
      ...
      <section className="relative min-h-[60vh] flex items-center overflow-hidden py-20 bg-gradient-to-br from-[#1F2937] via-[#111827] to-[#0F172A]" data-header-contrast="dark">
